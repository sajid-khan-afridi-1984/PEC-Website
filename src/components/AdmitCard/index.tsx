    ...
    <div className="mx-auto my-6 flex w-full max-w-4xl flex-col items-center justify-center gap-6">
      <div className="w-[95%] text-justify print:hidden">
        ...
        <p className="my-4">
          ...
          <b>
            Cyberabad&apos;s Initiative for &quot;Artificial Intelligence, Web
            3.0, and Cybersecurity&quot;,{" "}
            <i>A Nation Building Program By Collaboration of</i> Faisalabad
            Chamber of Commerce & Industry and PIAIC
          </b>
        </p>
        <p>
        ...
        <p className="mt-4">
          ...
          <b className="block font-bold">
            Cyberabad&apos;s Initiative for AI, Web 3.0 & Cybersecurity
          </b>
          <Link
      ...
      <button
        className="button-transition mt-5 w-[95%] bg-main py-3 text-center text-sm font-semibold tracking-widest text-white print:hidden sm:w-52 sm:py-4 sm:text-base"
