...
export default function Page() {
  ...
  useEffect(() => {
    ...
    if (!(facebook && youtube && twitter && instagram && linkedIn)) {
    ...
    <main className="mb-20 flex flex-col items-center justify-center">
      ...
      {!isApplied && (
        <form
          ...
          noValidate
        >
          <h1 className="mb-8 text-center text-lg font-bold text-main md:text-3xl">
          ...
          <label
            htmlFor="city"
            className="font-medium text-slate-700 md:text-xl"
          >
            City *
          </label>
          <select
          ...
          <Input
            ...
            errors={errors}
          />
          <label className="font-medium text-slate-700 md:text-xl">
            {" "}
            Gender *
          </label>
          ...
          <div className="flex w-full justify-center">
            <button
              type="submit"
              disabled={loading}
              className="text button-transition mt-5  w-52 bg-main py-4 text-center text-base font-semibold tracking-widest text-white disabled:opacity-60 disabled:hover:cursor-not-allowed sm:w-full sm:py-3 sm:text-sm"
            >
