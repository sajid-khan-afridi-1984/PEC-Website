export default function Page() {
  return (
    <div className="mt-16 px-8 text-justify lg:px-16">
      <h2 className="text-center text-2xl lg:text-4xl">
        <strong>Terms and Conditions</strong>
      </h2>

      <p className="font-medium">Welcome to Cyberabad!</p>

      <p className="font-medium">
        These terms and conditions outline the rules and regulations for the use
        of Cyberabad&apos;s Website, located at cyberabad.ai.
      </p>

      <p className="font-medium">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Cyberabad if you do not agree to take
      ...
      <p className="font-medium">
        We employ the use of cookies. By accessing Cyberabad, you agreed to use
        cookies in agreement with the Cyberabad&apos;s Privacy Policy.
      </p>
      ...
      <p className="font-medium">
        Unless otherwise stated, Cyberabad and/or its licensors own the
        intellectual property rights for all material on Cyberabad. All
        intellectual property rights are reserved. You may access this from
        Cyberabad for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p className="font-medium">You must not:</p>
      <ul>
        <li>Republish material from Cyberabad</li>
        <li>Sell, rent or sub-license material from Cyberabad</li>
        <li>Reproduce, duplicate or copy material from Cyberabad</li>
        <li>Redistribute content from Cyberabad</li>
      </ul>
      ...
      <p className="font-medium">
        ...
        Cyberabad does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Cyberabad,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Cyberabad shall not be liable
      ...
      <p className="font-medium">
        Cyberabad reserves the right to monitor all Comments and to remove any
      ...
      <p className="font-medium">
        You hereby grant Cyberabad a non-exclusive license to use, reproduce,
      ...
      <p className="font-medium">
        ...
        the hyperlink compensates the absence of Cyberabad; and (d) the link is
      ...
      <p className="font-medium">
        ...
        e-mail to Cyberabad. Please include your name, your organization name,
      ...
      <p className="font-medium">
        No use of Cyberabad&apos;s logo or other artwork will be allowed for
