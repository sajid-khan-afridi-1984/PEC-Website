...
const setApiKey = process.env.SENDGRID_API_KEY;
sgMail.setApiKey(process.env.SENDGRID_API_KEY!);

export async function POST(request: NextRequest) {
  console.log("🚀 ~ file: route.ts:8 ~ setApiKey:", setApiKey);
  ...
  try {
    ...
    console.log("🚀 ~ file: route.ts:46 ~ POST ~ transporter:", transporter);

    await transporter.sendMail({
      to: email, // Change to your recipient
      from: process.env.NEXT_PUBLIC_USER_EMAIL!, // Change to your verified sender
      subject: "Verify Email with Cyberabad's Website!",
    ...
    console.log("🚀 ~ file: route.ts:59 ~ POST ~ error:", error);
    return NextResponse.json(
      {
  ...
  let customerEmailTemplate = `
	...
	<table style="width:560px;margin:0;padding:0;font-family:Helvetica,Arial,sans-serif;border-collapse:collapse!important;height:100%!important;background-color:#ffffff" align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="m_7739369197626284510bodyTable">
		...
		<td align="center" valign="top" id="m_7739369197626284510bodyCell" style="margin:0;padding:0;font-family:Helvetica,Arial,sans-serif;height:100%!important">
            ...
            <img src="https://cyberabadtest.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.4357be5a.jpg&w=96&q=75" width="560" height="168" alt="OpenAI" title="" style="width:70px;height:auto;border:0;line-height:100%;outline:none;text-decoration:none" class="CToWUd" data-bit="iit">
			</p>
			</div>
